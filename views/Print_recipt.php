                        ...
                        <div class="row">
                            <div class="Contact-Form">
                              ...
                              <p style="font-size:15px;padding-left: 20px;padding-right: 20px;"> The below transaction has been successfully processed and a confirmation has been sent to your registered email ID</p>
                               <p style="padding-left: 20px;padding-right: 20px;padding-top: 20px;font-weight: bold;">Receipt Number : 123456789987 &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;&nbsp;           Date : <?php echo date("d-M-Y"); ?></p>
                               <p style="padding-left: 20px;padding-right: 20px;padding-top: 20px;font-weight: bold;">MetLife Policy Number : 4561237895 &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;&nbsp; Card Holders Name : <?php echo $member_name; ?>  </p>
